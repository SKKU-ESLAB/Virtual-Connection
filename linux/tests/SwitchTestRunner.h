...
class SwitchTestRunner : sc::ServerAdapterStateListener {
public:
  void start();
  static void on_start_sc(bool is_success);

private:
  static SwitchTestRunner *sTestRunner;
...
public:
  static SwitchTestRunner *test_runner(int throughput, int iterations);

private:
  SwitchTestRunner(int throughput, int iterations) {
