...
public:
  ...
  void send_request_disconnect(int adapter_id, uint32_t final_seq_no_control,
  ...
  void send_request_retransmit(int adapter_id, int segment_type,
                               uint32_t seq_no_start, uint32_t seq_no_end);
  void send_request_queue_status(uint32_t last_seq_no_control,
